                        ...
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-[#f4c8c8] hover:bg-[#eb9696] border-[#dd3333] px-4 py-3 rounded-xl" >
                                    ...
                                    <h2 className=" playfair font-medium text-3xl text-[#dd3333] fonts1" >{getAllProduct.length}</h2>
                                    <p className=" playfair text-[#dd3333]  font-bold" >Total Products</p>
                                </div>
                            </Tab>
                            ...
                            <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-[#f4c8c8] hover:bg-[#eb9696] border-[#dd3333] px-4 py-3 rounded-xl" >
                                    ...
                                    <h2 className="playfair font-medium text-3xl text-[#dd3333] fonts1" >{getAllOrder.length}</h2>
                                    <p className=" playfair text-[#dd3333]  font-bold" >Total Order</p>
                                </div>
                            </Tab>
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-[#f4c8c8] hover:bg-[#eb9696] border-[#dd3333] px-4 py-3 rounded-xl" >
                                    ...
                                    <h2 className="playfair font-medium text-3xl text-[#dd3333] fonts1" >{getAllUser.length}</h2>
                                    <p className=" text-[#dd3333]  font-bold" >Total Users</p>
                                </div>
                            </Tab>
                        </TabList>
